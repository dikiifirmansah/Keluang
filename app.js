...
(function initBackHandler() {
  ...
  window.addEventListener('popstate', e => {
    ...
    if (activePage && activePage.id !== 'page-beranda') {
      ...
      // Push state lagi setelah navigasi supaya back berikutnya masih tertangkap
      setTimeout(() => history.pushState({ app: 'keluang', level: 0 }, ''), 50);
      return;
    }
    // Sudah di beranda dan tidak ada yang terbuka — tampilkan konfirmasi keluar
    showExitConfirm();
  });
})();
